...
You can use the second part of this [script](https://github.com/dev-academy-programme/add-staff-and-students/blob/main/add-people-to-github-org/create-git-iam-student-file.js) to create the users.json. This script will automatically make a JSON object with the students' GitHub usernames as the object properties. Feel free to edit the property names.
